...
// dialog window
var dialog = new Window("dialog", "Random Selection \u00A9 randomill.com", undefined)
...
options.alignment = ["fill", "top"]

// selection method panel
var selectionMethodSelect = options.add("panel", undefined, "Selection Method:")
selectionMethodSelect.orientation = "column"
selectionMethodSelect.alignChildren = ["left", "top"]
selectionMethodSelect.margins = 16
selectionMethodSelect.alignment = ["fill", "top"]
...
// value field panel
var valueInputTextField = options.add("panel", undefined, "Value:")
valueInputTextField.orientation = "column"
valueInputTextField.alignChildren = ["left", "top"]
valueInputTextField.margins = 10
valueInputTextField.alignment = ["fill", "fill"]
var selectionValue = valueInputTextField.add("edittext", undefined, 50)
selectionValue.characters = 5
...
function randomizeSelection(objects) {
	...
	if (isNaN(value)) {
		throw new Error("Could not parse entered value.")
	}
