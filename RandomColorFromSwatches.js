...
// dialog window
var dialog = new Window("dialog", "Random Color (Swatches) \u00A9 randomill.com", undefined)
...
apply.onClick = function () {
	try {
		...
		randomizeColorsFromSwatch(swatches, objects)
		app.redraw()
	} catch (err) {
		alert("Error: \n" + err.message)
	}
...
function randomizeColorsFromSwatch(swatches, objects) {
	...
	for (i = 0; i < objects.length; i++) {
		...
		setColorProperty(item, swatches, randomizeWithinGroupsCheckbox.value === true, fillOrStroke)
	}
