 ...
 * PANEL UI
 */
var dialog = new Window("dialog", "Random Layer Order \u00A9 randomill.com", undefined)
...
var respectParentLayers = optionsPanel.add("checkbox", undefined, "Respect Parent Layers")
...
function collectObjectsByParentLayers(objects) {
	...
	*/
	...
	for (var i = 0; i < objects.length; i++) {
		...
		if (!topArr[objects[i].layer.absoluteZOrderPosition])
			topArr[objects[i].layer.absoluteZOrderPosition] = new Array()
